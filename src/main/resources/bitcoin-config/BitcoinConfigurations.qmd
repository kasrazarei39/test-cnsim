...
+--------------------------------------+------------------------------------------------------------------------------------+
| `light1.application.properties`      | As above but with:                                                                 |
|                                      |                                                                                    |
| ([Lightweight Bitcoin Simulation 1]) | -   $\lambda$ = 1 (instead of realistic)                                           |
|                                      |                                                                                    |
|                                      | -   Mean tx size = `1461.15` to make up for the fewer transactions.                |
|                                      |                                                                                    |
|                                      | -   This results for about 3600 arrivals per hour allowing for faster simulations. |
|                                      |                                                                                    |
|                                      | -   Target transactions are now {10,11,...20}                                      |
+--------------------------------------+------------------------------------------------------------------------------------+
|                                      |                                                                                    |
+--------------------------------------+------------------------------------------------------------------------------------+
